...
export default function LocationInput<T extends FieldValues>(props: Props<T>) {
    ...
    const [suggestuions, setSuggestions] = useState<LocationIQSuggestion[]>([])
    ...
    const locationUrl = 'https://api.locationiq.com/v1/autocomplete?key=pk.f7b5461826dcc025e3900a272a2bddb2&limit=5&dedupe=1&'
    ...
    return (
        <Box>
            ...
            {suggestuions.length > 0 && (
                <List sx={{ border: 1 }}>
                    {suggestuions.map((suggestion) => (
                        <ListItemButton
                            divider
